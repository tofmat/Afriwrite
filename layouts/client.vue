  ...
  <v-app>
    ...
    <div class="dashNav">
        <v-navigation-drawer permanent expand-on-hover absolute class="noMobile hoverNav" fixed>
            ...
            class="openNavFull"
            >
                <v-list-item link class="sideLinkCon" to="/client/jobs" router exact active-class="navActive">
                ...
                <v-list-item link class="sideLinkCon" to="/client/post" router exact active-class="navActive">
                ...
                <v-list-item link class="sideLinkCon">
                    <v-list-item-icon>
                      <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 23.616 24.323"><path d="M23.354,3H5.262a2.258,2.258,0,0,0-2.25,2.262L3,25.615l4.523-4.523H23.354a2.268,2.268,0,0,0,2.262-2.262V5.262A2.268,2.268,0,0,0,23.354,3ZM21.092,16.569H7.523v-1.7H21.092Zm0-3.392H7.523V11.51H21.092Zm0-3.18H7.523V8.523H21.092Z" transform="translate(-2.499 -2.5)"/></svg>
                    </v-list-item-icon>
                    <v-list-item-title>Messages</v-list-item-title>
                </v-list-item>
                <v-list-item link class="sideLinkCon" to="/client/proposals" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="/client/contracts" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="/client/profile" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="/client/transactions" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="reports" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="settings" router exact active-class="navActive">
                    <v-list-item-icon>
