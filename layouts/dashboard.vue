  ...
  <v-app>
    ...
    <div class="dashNav">
        <v-navigation-drawer permanent expand-on-hover absolute class="noMobile hoverNav" fixed>
            ...
            class="openNavFull"
            >
                <v-list-item link class="sideLinkCon" to="/dashboard/jobfeed" router exact active-class="navActive">
                ...
                <v-list-item link class="sideLinkCon" to="/dashboard/saved" router exact active-class="navActive">
                ...
                <v-list-item link class="sideLinkCon" to="proposals" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="contracts" router exact active-class="navActive">
                    <v-list-item-icon>
                ...
                <v-list-item link class="sideLinkCon" to="transactions" router exact active-class="navActive">
                    <v-list-item-icon>
